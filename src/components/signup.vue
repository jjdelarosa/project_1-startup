<template>
    ...
    <h1 class="text-6xl text-white font-bold">Sign Up
    </h1>
    <h3 class="text-2xl text-white">If you feel this community of coders is right for you then sign up
        and join the team of wonderful peopole who will help you code in your journey.
