<template>
    <div class="pt-24 min-h-screen w-screen top flex flex-col flex-wrap justify-center items-center px-8 bg-purple-500 shadow-lg">
        <h1 class=" font-bold text-5xl">A Developer</h1>
        <h3 class="text-2xl">
